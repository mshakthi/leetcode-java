 ...
 * 
 * This class provides functionality to reverse nodes in a linked list in groups
 * of k.
 * If the number of nodes is not a multiple of k, the remaining nodes are left
 * as is.
 * 
